  ...
  Fields: [
    {
      ...
      label: 'Synopsis',
      required: true,
      errorMessage: 'Please enter a valid synopsis',
    },
    {
      name: 'castAndCredits',
      label: 'Cast & Credits',
      required: true,
      errorMessage: 'Please enter a valid cast & credits',
    },
    {
      name: 'songLines',
      label: 'Song Lines',
      required: true,
      errorMessage: 'Please enter a valid song lines',
    },
    {
      name: 'poster',
      label: 'Poster',
      required: true,
      errorMessage: 'Please enter a valid poster',
    },
  ],
};

  ...
  return (
    <div className='py-4'>
      <div className=' flex flex-col py-8 '>
        <div className='text-xl text-red-500 text-center'>Around the Odisha</div>
        <div className='text-2xl text-white font-bold md:text-4xl text-center'>LOCATION DIRECTORY</div>
      </div>
            ...
            <div key={index} className="px-2">
              <div className="relative group overflow-hidden rounded-md">
                ...
                <div className="absolute inset-0 p-4 bg-gradient-to-t from-black/70 to-transparent text-white  justify-center items-center flex flex-col transition duration-500">
                  <h2 className='text-xl font-semibold group-hover:block hidden '>Places In</h2>
                  <h3 className="text-2xl font-bold group-hover:hidden">{destination.title}</h3>
                </div>
                <Link
      ...
      <div className="text-center transition duration-300 group mt-8">
        ...
        >
          <span>More</span>
          <span className="ml-2 group-hover:ml-2 transform transition-transform duration-300 group-hover:translate-x-1">→</span>
        </Link>
      </div>
    </div>
  );

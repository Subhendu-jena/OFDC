...
const LocationDetails: React.FC = () => {
  const [activeLocation] = useState<LocationCard>({
    title: 'Konark',
    subTitle: 'Sun Temple',
    ...
    images: [
      {
        url: '/uploads/Konark_8c5bcb470c.png',
        width: 500,
        height: 560,
        formats: {
          small: {
            url: '/uploads/small_Konark_8c5bcb470c.png',
          },
        },
      },
    ],
      ...
      {/* Image Carousel */}
        ...
        >{demoImages.map((image, index) => (
          <img
            src={image}
            // alt={title}
            className=" w-full h-[100vh]  object-cover transition-transform duration-500 md:h-[50vh] w-1/2"
          />))}
        </Slider>
      </div>

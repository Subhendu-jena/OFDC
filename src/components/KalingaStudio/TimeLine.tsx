...
//       <div className="absolute mt-[530px] ml-[150px] flex justify-center ">
//         {' '}
//         <div className="w-[400px] bg-[#d30000bd] p-6 rounded-lg shadow-md ">
...
//         </div> */}
//       </div>
//       <div className="absolute mt-[720px] ml-[900px] flex justify-center ">
//         {/* {' '}<div className="text-black text-3xl font-extrabold mr-[-20px] mt-[40px]">
//         2
//         </div> */}
//         <div className="w-[400px] bg-[#046900c0] p-6 rounded-lg shadow-md ">
//           <h3 className=" text-white text-xl mb-2 font-extrabold">
//             4 Establishment
//           </h3>
//           <p className="text-white mb-2">July 25, 1980</p>
...
//         </div>
//       </div>
//       <div className="relative flex items-center justify-center mt-10 mb-10 w-full h-full">
//         {' '}
//         <img src={blueR} alt="" className="relative" />{' '}
//       </div>
//       <div className= "absolute mt-[-700px] ml-[900px] flex justify-center ">
//         {/* {' '}<div className="text-black text-3xl font-extrabold  mt-[40px]">
//         2
//         </div> */}
  ...
  return (
    ...
    <div className="w-full  justify-center  items-center mx-auto mb-20 hidden md:block">
      <div className="relative max-w-7xl h-[700px]">
        ...
        {/* div 1 */}
        <div className="absolute 2xl:top-25  md:left-0 w-[320px] xl:w-[360px] 2xl:left-25 left-0 md:top-5">
          <div className="bg-[#244470d5] p-6 rounded-lg shadow-md ">
            <h3 className="text-white text-xl mb-1 font-extrabold">
              Establishment
            </h3>
            <p className="text-white mb-1">July 25, 1980</p>
            <p className="text-white">
              Established as a joint venture between OFDC and M/s. Sarada
              Enterprises
            </p>
        ...
        {/* div 2 */}
        <div className="absolute 2xl:top-70 2xl:right-30 w-[320px] xl:w-[360px] right-10 md:right-10 md:top-40 xl:top-45">
          <div className="bg-[#7e118cc7] p-6 rounded-lg shadow-md ">
            <h3 className="text-white text-xl mb-1 font-extrabold">
              Commercial Operations
            </h3>
            <p className="text-white mb-1">May 5, 1982</p>
            <p className="text-white">
              Started commercial operations and began serving the Odisha film
              industry
            </p>
          </div>
        </div>
        {/* div 3 */}
        <div className="absolute 2xl:top-110 2xl:left-25  w-[340px] xl:w-[360px] top-110 left-0 md:left-0 md:top-80">
          <div className="bg-[#d30000bd] p-6 rounded-lg shadow-md ">
            <h3 className="text-white text-xl mb-1 font-extrabold">
              Full OFDC Acquisition
            </h3>
            <p className="text-white mb-1">July 1983</p>
            <p className="text-white">
        ...
        {/* div 4 */}
        <div className="absolute 2xl:top-150 2xl:right-30  w-[320px] xl:w-[360px] right-20 md:right-10 md:top-105 md:w-[320px] xl:top-120">
          <div className="bg-[#046900c0] p-6 rounded-lg shadow-md ">
            <h3 className="text-white text-xl mb-1 font-extrabold">
              Renovation Project
            </h3>
            <p className="text-white mb-1">Present</p>
            <p className="text-white">
    ...
    {/* Mobile View - Content for Mobile Screens (visible on mobile) */}
    <div className="block md:hidden">
      <div className='grid grid-cols-2 gap-2 p-3'>
        ...
        <div className="bg-[#244470d5] p-6 rounded-lg shadow-md mb-2">
            <h3 className="text-white text-xl mb-1 font-extrabold">
              Establishment
            </h3>
            <p className="text-white mb-1">July 25, 1980</p>
        ...
        <div>
        <div className="bg-[#d30000bd] p-6 rounded-lg shadow-md mb-2">
            <h3 className="text-white text-xl mb-1 font-extrabold">
              Full OFDC Acquisition
            </h3>
            <p className="text-white mb-1">July 1983</p>

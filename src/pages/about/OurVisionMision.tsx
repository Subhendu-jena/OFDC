import { CheckCheck, Eye, MoveRight } from 'lucide-react';
              ...
              <div className="flex flex-col">
                ...
                <div className=" p-8 ">
                  ...
                  <div className="w-full  grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-x-4 gap-y-16">
                    {data[0]?.aboutUsCard?.map((text: any, index: number) => {
                      return (
                        <div
                          key={index}
                          className={`relative  bg-white rounded-tr-3xl rounded-bl-4xl p-8 group ${index === data[0]?.aboutUsCard?.length - 1 ? 'mb-0' : ''}`}
                        >
